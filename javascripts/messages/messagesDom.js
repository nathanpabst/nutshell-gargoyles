...
const printMessages = (messagesArray) => {
  ...
  messagesArray.forEach((message) => {
    ...
    if (activeUserId === message.userUid) {
      ...
      domString += `    <p class="chat-message-detail chat-message-timestamp-me">${message.timestamp}</p>`;
      ...
      domString += `    <p class="chat-message-detail chat-message-timestamp-other">${message.timestamp}</p>`;
